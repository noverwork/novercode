...
4. **Commit**: Create a commit with a descriptive message following conventional commit format
5. **Push**: Push the branch to origin with upstream tracking
6. **Create PR**: Use `gh pr create` to create a Pull Request with:
