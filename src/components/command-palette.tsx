...
export function CommandPalette({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="bg-black border border-green-900 text-green-500 font-mono max-w-2xl">
        <DialogHeader>
          <DialogTitle className="text-green-500">command palette</DialogTitle>
        </DialogHeader>
        ...
        <div className="space-y-4 py-4">
          <div className="relative">
            ...
            <Input
              ...
              autoFocus
              className="pl-10 bg-black border-green-900 text-green-400 placeholder:text-green-900 font-mono"
            />
            <div className="absolute right-3 top-1/2 -translate-y-1/2 text-xs text-green-900">
                    ...
                    <button
                      ...
                      className={`w-full flex items-center gap-3 px-3 py-2.5 rounded font-mono text-sm text-left transition-colors ${
                        isSelected
                          ...
                          : 'hover:bg-green-900/20 text-green-700'
                      }`}
                    >
                      <div className="w-16 flex items-center justify-center text-xs uppercase text-green-900">
                        {result.type}
                      </div>
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {result.type === 'task' && result.task?.description && (
                          <p className="text-xs text-green-800 truncate mt-1 ml-5">
                            {result.task.description}
                          </p>
                        )}

                        {result.type === 'task' && (
                          <p className="text-xs text-green-900 mt-1 ml-5">
          ...
          {results.length > 0 && (
            <div className="text-xs text-green-900 font-mono border-t border-green-900 pt-3 flex justify-between">
              <span>
